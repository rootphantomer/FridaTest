  ...
  })()(
    {
      ...
      26: [
        function (require, module, exports) {
          ...
          rpc.exports.objectGetField = function objectGetField(
            handle,
            field,
            clazz
          ) {
          ...
          var getObjectByHandle = function getObjectByHandle(handle) {
            if (!utils_1.hasOwnProperty(exports.handleCache, handle)) {
              if (handle.startsWith("0x")) {
                ...
                exports.handleCache[handle] = Java.cast(
                  ptr(handle),
                  Java.use(origClassName)
                );
              } else {
            ...
            Java.perform(function () {
              try {
                ...
                while (entrySet.hasNext()) {
                  ...
                  result["[" + keyHandle + "]: " + objectToStr(key)] =
                    "[" + valueHandle + "]: " + objectToStr(value);
                }
              } catch (e) {
                console.error(e);
              }
          ...
          exports.collectionDump = function (handle) {
            ...
            Java.perform(function () {
              try {
                ...
                var objectArray =
                  collectionClass.toArray.apply(collectionObject);
        ...
        function (require, module, exports) {
          ...
          var ClassWrapper = /*#__PURE__*/ (function () {
            function ClassWrapper(handle) {
              ...
              handle["class"]
                .getInterfaces()
                .forEach(function (interfaceClass) {
          ...
          function getHandle(object) {
            try {
              ...
              if (
                ...
                var hashcode =
                  Java.use("java.lang.Object").hashCode.apply(object);
