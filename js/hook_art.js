(function () {
  ...
  class StdString {
    ...
    _getData() {
      ...
      const data = isTiny
        ? str.add(1)
        : str.add(2 * Process.pointerSize).readPointer();
      return [data, isTiny];
    }
  }
  ...
  function prettyMethod(method_id, withSignature) {
    ...
    Java.api["art::ArtMethod::PrettyMethod"](
      result,
      method_id,
      withSignature ? 1 : 0
    );
    ...
    for (var i = 0; i < symbols.length; i++) {
      ...
      if (
        ...
        if (symbol.name.indexOf("GetStringUTFChars") >= 0) {
          ...
          Interceptor.attach(symbol.address, {
            onEnter: function (args) {
              ...
              if (module != null && module.name.indexOf(so_name) == 0) {
                ...
                var obj_class_name = Java.vm
                  .tryGetEnv()
                  .getObjectClassName(jobject);
          ...
          symbol.name.indexOf("Call") >= 0 &&
          symbol.name.indexOf("Method") >= 0
        ) {
          ...
          Interceptor.attach(symbol.address, {
            onEnter: function (args) {
              ...
              if (module != null && module.name.indexOf(so_name) == 0) {
                var java_class = args[1];
                var mid = args[2];
                var class_name = Java.vm
                  .tryGetEnv()
                  .getObjectClassName(java_class);
                if (
                  class_name.indexOf("java.") == -1 &&
                  class_name.indexOf("android.") == -1
                ) {
        ...
        onLeave: function (retval) {
          if (retval != null) {
            ...
            if (module != null && module.name.indexOf(so_name) == 0) {
              ...
              console.log(
                "[GetStringUTFChars] result:" + bytes,
                DebugSymbol.fromAddress(this.returnAddress)
              );
            }
          }
          ...
          if (args[2] != null) {
            ...
            if (module != null && module.name.indexOf(so_name) == 0) {
              ...
              if (args[3] != null) {
                ...
                console.log(
                  "[GetMethodID] class_name:" + class_name + " name:" + name,
                  DebugSymbol.fromAddress(this.returnAddress)
                );
              }
            }
          ...
          if (args[2] != null) {
            ...
            if (module != null && module.name.indexOf(so_name) == 0) {
              ...
              if (args[3] != null) {
                var sig = Memory.readCString(args[3]);
                console.log(
                  "[GetStaticFieldID] name:" + name + ", sig:" + sig,
                  DebugSymbol.fromAddress(this.returnAddress)
                );
              } else {
                console.log(
                  "[GetStaticFieldID] name:" + name,
                  DebugSymbol.fromAddress(this.returnAddress)
                );
              }
            }
