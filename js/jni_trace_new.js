      ...
      1: [
        function (require, module, exports) {
          ...
          function hook_jni(library_name, function_name) {
            ...
            Module.enumerateExportsSync(library_name).forEach(function (
              symbol
            ) {
              ...
              if (symbol.name == function_name) {
                ...
                Interceptor.attach(symbol.address, {
                  onEnter: function (args) {
                    ...
                    klog(
                      "[+] Hooked successfully, JNIEnv base adress :" +
                        jnienv_addr
                    );
                    /*
                    ...
                    */
                    ...
                    Interceptor.attach(
                      jni.getJNIFunctionAdress(jnienv_addr, "FindClass"),
                      {
                        onEnter: function (args) {
                          klog(
                            'env->FindClass("' +
          ...
          if (library_name == "" || function_name == "") {
            klog(
              "[-] You must provide a function name and a library name to hook"
            );
          } else {
            klogData(
              "",
              "init",
              "jni_trace_new.js init hook success library_name:" +
                library_name +
                ",function_name:" +
                function_name
            );
...
*/
          function getJNIFunctionAdress(jnienv_addr, func_name) {
            var offset =
              jni_struct_array.indexOf(func_name) * Process.pointerSize;
