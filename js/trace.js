  ...
  function traceClass(clsname) {
    try {
            ...
            if (isMatch) {
              if (
                method
                  .getName()
                  .toUpperCase()
                  .indexOf(matchsplit[1].toUpperCase()) != -1
              ) {
                flag = true;
                break;
              }
              ...
              if (
                method.getName().toUpperCase() == matchsplit[1].toUpperCase()
              ) {
                flag = true;
                break;
              }
      ...
      methodNames.forEach(function (methodName) {
        ...
        if (
          clsname == "android.os.Bundle" &&
          methodName.indexOf("writeToParcel") == 0
        ) {
          return;
        }
    ...
    if (ex[1] == ":") {
      ...
      if (mode == "E") {
        ...
        log(
          "Unknown match mode: " +
            mode +
            ", current support M(match) and E(equal)"
        );
      }
    }
